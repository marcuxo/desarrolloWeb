	...
	<div class="container">
		<div class="row">
			...
			<div class="col-7 text-right align-bottom">
				<a href="./ingresoCliente.php" class="btn btn-success btn-sm" role="button" aria-pressed="true"><b>Agregar Cliente</b></a>
					...
					<table border="1">
						<thead>
							<tr>
								...
								<th class="text-center bg-faded lead">Monto$</th>
								<th class="text-center bg-faded lead">Datos</th>
								<th class="text-center bg-faded lead" id="lacapa">Acciones</th>
							</tr>
						</thead>
							<tr>
								...
								<button class="btn btn-danger btn-sm">RECHAZAR</button></td>
							</tr>
							<!-- borrrar -->
							<tr>
							...
							<tr>
								...
								<td class="text-center">Gaston Mazuela</td>
							...
							<div class="modal fade" id="modal1">
								<div class="modal-dialog">
									<div class="modal-content bg-faded">
										<div class="modal-hedear px-2 pt-2">
										...
										<div class="modal-body">
											...
											<input type="text" value="12345678-9" disabled>
											<input type="text" value="nombre" name="nombre_cli"><br>
											<input type="text" value="apellidos" name="apell" size="45"><br>
											...
											<label for="" class="lead">Cambiar Foto</label><br>
											<input type="file" name="file" required><br>
											<p class="img">aqui</p>
											<hr>
											<input type="text" value="cuenta vista" name="cuenta" class="font-weight-bold" disabled>
											<input type="text" value="500.000" name="monto"><br>
											<input type="text" value="cuenta de ahorro" name="cuenta" class="font-weight-bold" disabled>
											<input type="text" value="500.000" name="monto"><br>
											<input type="text" value="cuenta corriente" name="cuenta" class="font-weight-bold" disabled>
